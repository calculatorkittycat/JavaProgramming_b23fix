package day_39_CustomeClasses_Static.studentsTask;
...
public class CybertekSchool {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Student> thirdMarketGroup = new ArrayList<>();//c
        ...
        System.out.println("first market group " +firstMarketGroup.size());
        System.out.println("second market group " +secondMarketGroup.size());
        System.out.println("third market group " +thirdMarketGroup.size());

        // who is the youngest student in first market group
