package day_48_review.cybertekTask;
    ...
    //if variable is made to be static there will only be one copy
    // if made instance it can be changed
    //final variables demand to be initialized before you use them
